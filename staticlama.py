...
def main():
    ...
    parser.add_argument("--part", default="trex", type=str, required=False, help="trex,googlere")
    parser.add_argument("--relations", default="all", type=str, required=False, help="")
    parser.add_argument("--similaritymeasure", default="cosine", type=str, required=False, help="")
    parser.add_argument("--details", default=None, type=str, required=False, help="")
    parser.add_argument("--summary", default=None, type=str, required=True, help="")
    parser.add_argument("--prefix", default="", type=str, required=False, help="")
    parser.add_argument("--lm", default=None, type=str, required=False, help="")
    parser.add_argument("--lmstatic", default=None, type=int, required=False, help="")
    parser.add_argument("--model_type", default="bert", type=str, required=False, help="")
    parser.add_argument("--lang", default="en", type=str, required=False, help="")
    parser.add_argument("--embeddings", default=None, type=str, required=False, help="")
    parser.add_argument("--idfilter", default=None, type=str, required=False, help="")
    parser.add_argument("--vocab", default=None, type=str, required=False, help="")
    parser.add_argument("--topn", default=1, type=int, required=False, help="")
    parser.add_argument("--min_layers", default=-1, type=int, required=False, help="")
    parser.add_argument("--max_layers", default=-1, type=int, required=False, help="")
    parser.add_argument("--normalize", action="store_true", help="")
    parser.add_argument("--majority", action="store_true", help="")
    parser.add_argument("--do_not_use_templates", action="store_true", help="")
    parser.add_argument("--add_relationvector", action="store_true", help="")
    parser.add_argument("--add_template_to_subject", action="store_true", help="")
    parser.add_argument("--mode", default="predict", type=str, required=False, help="predict, evaltyping")
    ...
    if args.lm:
        if args.lmstatic is not None:
            ...
            lm = LMPredictor(args.lm, args.lm, args.model_type,
                             min_layers=args.min_layers, max_layers=args.max_layers, use_templates=not args.do_not_use_templates)
            if args.mode == "predict":
